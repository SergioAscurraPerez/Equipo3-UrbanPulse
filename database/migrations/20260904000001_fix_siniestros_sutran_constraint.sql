...
-- que el ALTER TABLE fallo y el constraint nunca se creo. Sin el, el
-- INSERT
-- ON CONFLICT del flujo de ingesta SUTRAN no tiene con que emparejar y
...
BEGIN
    IF NOT EXISTS (
        ...
        ADD CONSTRAINT uq_siniestro_sutran
        UNIQUE (
