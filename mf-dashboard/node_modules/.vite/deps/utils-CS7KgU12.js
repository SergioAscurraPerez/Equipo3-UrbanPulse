...
//#endregion
//#region node_modules/@module-federation/sdk/dist/env.js
...
//#endregion
//#region node_modules/@module-federation/sdk/dist/node.js
...
var lazyLoaderHookFetch = async (input, init, loaderHook) => {
	const hook = (url, init) => {
...
var isFetchableRemoteModuleUrl = (url) => url.startsWith("http:") || url.startsWith("https:");
var isBareModuleSpecifier = (specifier) => !specifier.startsWith("./") && !specifier.startsWith("../") && !specifier.startsWith("/") && !specifier.includes(":");
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/global.js
var MAX_PRELOADED_ASSETS = 2e3;
...
function setGlobalDefaultVal(target) {
	...
	target.__FEDERATION__.__PRELOADED_ASSETS__ ??= /* @__PURE__ */ new Set();
}
...
function setGlobalFederationConstructor(FederationConstructor, isDebug = isDebugMode()) {
	if (isDebug) {
		...
		CurrentGlobal.__FEDERATION__.__DEBUG_CONSTRUCTOR_VERSION__ = "2.9.0";
	}
}
...
var getPreloadedAsset = (url) => CurrentGlobal.__FEDERATION__.__PRELOADED_ASSETS__.has(url);
var setPreloadedAsset = (url) => {
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/utils/semver/constants.js
...
function getRegisteredShare(localShareScopeMap, pkgName, shareInfo, resolveShare, loadContext) {
...
//#endregion
//#region node_modules/@module-federation/error-codes/dist/desc.mjs
var runtimeDescMap = {
...
var remoteEntryLoadingOrigins = /* @__PURE__ */ new WeakMap();
var esmRemoteEntryLoadErrorMessages = [
...
async function getRemoteEntry(params) {
	...
	if (!globalLoading[uniqueKey]) {
		...
		globalLoading[uniqueKey] = loadEntryHook.emit({
			...
			if (loadError instanceof Error && loadError.message.includes("RUNTIME-008") && !isScriptExecutionError && !_inErrorHandling) {
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/helpers.js
var helpers_default = {
	global: {
		Global,
		nativeGlobal,
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/utils/hooks/pluginSystem.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/utils/hooks/syncHook.js
var SyncHook = class {
	constructor(type) {
		this.type = "";
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/utils/hooks/asyncHook.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/utils/hooks/asyncWaterfallHooks.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/remote/disabled.js
var REMOTE_DISABLED_MESSAGE = "Remote loading is disabled by experiments.optimization.disableRemote.";
			...
			if (!isRemoteInfoWithEntry(remote) || !isPureRemoteEntry(remote)) {
				...
				if (preloadConfig) {
					...
					if (assets) preloadAssets(remoteInfo, origin, assets, false, {
						initiator: "loadRemote",
						id
					}, preloadConfig.recordPreloadedAssets).catch(() => void 0);
				}
				return {
					...args,
					remoteSnapshot
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/plugins/snapshot/disabled.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/shared/index.js
var SharedHandler = class {
	...
	async loadShare(pkgName, extraOptions) {
		...
		try {
			...
			const { shared: registeredShared, useTreesShaking } = getRegisteredShare(this.shareScopeMap, pkgName, shareOptionsRes, this.hooks.lifecycle.resolveShare, loadContext) || {};
			if (registeredShared) {
				...
				const asyncLoadProcess = async () => {
					...
					targetShared.loaded = true;
					addUseIn(targetShared, host.options.name);
					const { shared: gShared, useTreesShaking: gUseTreeShaking } = getRegisteredShare(this.shareScopeMap, pkgName, resolvedShareOptions, this.hooks.lifecycle.resolveShare, loadContext) || {};
					if (gShared) {
	...
	*/
	...
	loadShareSync(pkgName, extraOptions) {
		...
		try {
			...
			const { shared: registeredShared } = getRegisteredShare(this.shareScopeMap, pkgName, shareOptions, this.hooks.lifecycle.resolveShare, loadContext) || {};
			if (registeredShared) {
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/shared/disabled.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/remote/index.js
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/core.js
var USE_SNAPSHOT = typeof FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN === "boolean" ? !FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN : true;
var USE_REMOTE = typeof FEDERATION_OPTIMIZE_NO_REMOTE === "boolean" ? !FEDERATION_OPTIMIZE_NO_REMOTE : true;
var USE_SHARED = typeof FEDERATION_OPTIMIZE_NO_SHARED === "boolean" ? !FEDERATION_OPTIMIZE_NO_SHARED : true;
...
//#endregion
//#region node_modules/@module-federation/runtime-core/dist/index.js
var helpers = helpers_default;
var Module = typeof FEDERATION_OPTIMIZE_NO_REMOTE === "boolean" && FEDERATION_OPTIMIZE_NO_REMOTE ? UnavailableRemoteModule : Module$1;
//#endregion
...
//#endregion
export { loadScript as _, getRemoteEntry as a, RUNTIME_009 as c, getGlobalFederationConstructor as d, registerGlobalPlugins as f, loadScriptNode as g, assert as h, ModuleFederation as i, satisfy as l, setGlobalFederationInstance as m, Module as n, getRemoteInfo as o, setGlobalFederationConstructor as p, helpers as r, runtimeDescMap as s, getGlobalFederationInstance as t, CurrentGlobal as u };
